...
% Step Info (SettlingTime padrão do MATLAB é 2%, compatível com Python que estou tentando adaptar)
SI = stepinfo(Gs, 'SettlingTimeThreshold', 0.02);

% Cálculo do Undershoot (MATLAB retorna positivo, Python também - Graças a Deus)
